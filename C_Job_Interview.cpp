...
void Atable_for_Ashish(vl &vp, vl &vp_2, ll &Akj123, ll Ajk, ll &n, ll &m, ll &Ajk12, vi &vm1, vi &vm2, ll &Akj12) {
    fl (i, n+m+1) {
        if (vp[i] > vp_2[i] && Akj123 <= n) {
            Akj12 += vp[i];
            Akj123 += 1;
            vm1[i] = 1;
        } 
        else if (vp[i] < vp_2[i] && Ajk < m) {
            Akj12 += vp_2[i];
            Ajk += 1;
            vm1[i] = 0;
        } 
...
void Atable(vl &vp, vl &vp_2, ll &Akj123, ll Ajk, ll &n, ll &m, ll &Ajk12, vi &vm1, vi &vm2) {
    fl (i, n+m+1) {
        if (vp[i] < vp_2[i] && Ajk <= m) {
            Ajk12 += vp_2[i];
            Ajk += 1;
            vm2[i] = 0;
        } 
        else if (vp[i] > vp_2[i] && Akj123 < n) {
            Ajk12 += vp[i];
            Akj123 += 1;
            vm2[i] = 1;
        }
...
void solve(){
    ...
    ll Akj12 = 0, Ajk12 = 0;
    ll Akj123 = 0, Ajk = 0;
    vi vm1(n+m+1), vm2(n+m+1);
    Atable_for_Ashish(vp, vp_2, Akj123, Ajk, n, m, Ajk12, vm1, vm2, Akj12);
    Ajk = 0;
    Akj123 = 0;
    Atable(vp, vp_2, Akj123, Ajk, n, m, Ajk12, vm1, vm2);
    fl(i, n+m+1) {
        ll v1 = 0;
        if (vm1[i] == 1) {
            v1 = Akj12 - vp[i];

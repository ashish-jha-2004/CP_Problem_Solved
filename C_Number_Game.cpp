...
void solve(){
    ...
    if (n & 1) {
        ...
        ll temp = n;
        ll pow_of_2 = func1(temp);
        // debug(pow_of_2);
        if (pow_of_2 > 1 and temp / pow(2, pow_of_2) > 1) {
            cout << "Ashishgup\n";
        }
        else if (pow_of_2 > 1 and temp / pow(2, pow_of_2) == 1) {
            cout << "FastestFinger\n";
        }
        else {
            ll num = temp / 2;
            // debug(num);
            if(is_prime(num)) cout << "FastestFinger\n";
            else cout << "Ashishgup\n";
        }
    }

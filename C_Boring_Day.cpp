...
#define d_n(...) GET_MACRO(__VA_ARGS__, d_n10, d_n9, d_n8, d_n7, d_n6, d_n5, d_n4, d_n3, d_n2, d_n1)(__VA_ARGS__)
#define d_n1(a1) ll a1; std::cin >> a1;
#define d_n2(a1, a2) ll a1, a2; std::cin >> a1 >> a2;
#define d_n3(a1, a2, a3) ll a1, a2, a3; std::cin >> a1 >> a2 >> a3;
#define d_n4(a1, a2, a3, a4) ll a1, a2, a3, a4; std::cin >> a1 >> a2 >> a3 >> a4;
#define d_n5(a1, a2, a3, a4, a5) ll a1, a2, a3, a4, a5; std::cin >> a1 >> a2 >> a3 >> a4 >> a5;
#define d_n6(a1, a2, a3, a4, a5, a6) ll a1, a2, a3, a4, a5, a6; std::cin >> a1 >> a2 >> a3 >> a4 >> a5 >> a6;
#define d_n7(a1, a2, a3, a4, a5, a6, a7) ll a1, a2, a3, a4, a5, a6, a7; std::cin >> a1 >> a2 >> a3 >> a4 >> a5 >> a6 >> a7;
#define d_n8(a1, a2, a3, a4, a5, a6, a7, a8) ll a1, a2, a3, a4, a5, a6, a7, a8; std::cin >> a1 >> a2 >> a3 >> a4 >> a5 >> a6 >> a7 >> a8;
#define d_n9(a1, a2, a3, a4, a5, a6, a7, a8, a9) ll a1, a2, a3, a4, a5, a6, a7, a8, a9; std::cin >> a1 >> a2 >> a3 >> a4 >> a5 >> a6 >> a7 >> a8 >> a9;
#define d_n10(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) ll a1, a2, a3, a4, a5, a6, a7, a8, a9, a10; std::cin >> a1 >> a2 >> a3 >> a4 >> a5 >> a6 >> a7 >> a8 >> a9 >> a10;

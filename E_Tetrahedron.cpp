...
void solve(){
   ...
   dp[0][3] = 1;
   for(int i = 0; i < n; i++){
    dp[i + 1][0] = ((1ll *dp[i][1] % MOD) + (1ll * dp[i][2] % MOD) + (1ll * dp[i][3] %  MOD)) % MOD;
    dp[i + 1][1] = ((1ll * dp[i][0] % MOD) + (1ll * dp[i][2] % MOD) + (1ll *dp[i][3] %  MOD)) % MOD;
    dp[i + 1][2] = ((1ll *dp[i][1] % MOD) + (1ll * dp[i][0] % MOD) + (1ll * dp[i][3] %  MOD)) % MOD;
    dp[i + 1][3] = ((1ll *dp[i][1] % MOD) + (1ll * dp[i][2] % MOD) + (1ll * dp[i][0] %  MOD)) % MOD;

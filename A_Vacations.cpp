...
ll func(vl &v, ll ind, char prev) {
    ...
    ll ans = INT_MAX;
    if (v[ind] == 0) {
        ans = min(ans, func(v, ind + 1, 'n') + 1);
    }
    else if (v[ind] == 1) {
        if (prev == 'c') ans = min(ans, func(v, ind + 1, 'n') + 1);
        else ans = min(ans, min(func(v, ind + 1, 'c'), func(v, ind + 1, 'n') + 1));
    }
    else if (v[ind] == 2) {
        if (prev == 'g') ans = min(ans, func(v, ind + 1, 'n') + 1);
        else ans = min(ans, min(func(v, ind + 1, 'g'), func(v, ind + 1, 'n') + 1));
    }
    else if (v[ind] == 3) {
        if (prev == 'g') ans = min(ans, min(func(v, ind + 1, 'c'), func(v, ind + 1, 'n') + 1));
        else if (prev == 'c') ans = min(ans, min(func(v, ind + 1, 'g'), func(v, ind + 1, 'n') + 1));
        else ans = min(ans, min(func(v, ind + 1, 'g'), min(func(v, ind + 1, 'c'), func(v, ind + 1, 'n') + 1)));
    }
